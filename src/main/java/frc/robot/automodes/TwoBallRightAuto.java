...
public class TwoBallRightAuto extends ZekeAutoMode {
    ...
    public TwoBallRightAuto(ZekeAutoController ctrl, String name) throws Exception {
        super(ctrl, name);
        ...
        driveAndCollect("twoballupper_p1", 1.0, 2.0, FirstFireAngle, shoot);
        ...
        addSubActionPair(db, new TankDrivePathFollowerAction(db, "twoballupper_p2", false), true);
    }
}
