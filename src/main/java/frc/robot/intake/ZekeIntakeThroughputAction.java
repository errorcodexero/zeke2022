...
public class ZekeIntakeThroughputAction extends Action {
    ...
    public ZekeIntakeThroughputAction(ZekeIntakeSubsystem subsystem)
    ...
    public void run() throws Exception {
        ...
        if (left_color_ != CargoType.None && right_color_ != CargoType.None
